...
public class ACMEMedicalService implements Serializable {
    ...
    public void deletePhysicianById(int id) {
        ...
        if (physician != null) {
            ...
            /* TODO ACMECS02 - Use NamedQuery on SecurityRole to find this related Student
               ...
               is not dangling
            */ em.createNamedQuery(SecurityUser.SECURITY_USER_BY_Physician_ID_QUERY, SecurityUser.class);
    ...
    public MedicalSchool getMedicalSchoolById(int id) {
        TypedQuery<MedicalSchool> specificMedicalSchoolQuery = em.createNamedQuery(SPECIFIC_MEDICAL_SCHOOL_QUERY_ID, MedicalSchool.class);
    ...
    public MedicalSchool deleteMedicalSchool(int id) {
    	...
    	MedicalSchool ms = getById(MedicalSchool.class, MedicalSchool.SPECIFIC_MEDICAL_SCHOOL_QUERY_ID, id);
        if (ms != null) {
